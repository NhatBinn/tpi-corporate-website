...
const productsByCategory: Record<string, Product[]> = {
  "noi-bat": [
    {
      name: "TPI SKIMCOAT",
      desc: "Vữa tô nhẵn mịn cho bề mặt tường và trần",
      image: "/products/skimcoat.jpg",
      href: "/san-pham/tpi-skimcoat",
    },
    {
      name: "TPI HARD P",
    ...
    {
      name: "TPI WB-102",
      desc: "Chất tháo khuôn đa dụng (gốc nước)",
      image: "/products/wb-102.jpg",
      href: "/san-pham/tpi-wb-102",
    },
    {
      name: "TPI A100",
